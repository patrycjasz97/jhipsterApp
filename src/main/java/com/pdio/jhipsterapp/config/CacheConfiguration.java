package com.pdio.jhipsterapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.pdio.jhipsterapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.pdio.jhipsterapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
