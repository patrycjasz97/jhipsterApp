...
import com.pdio.jhipsterapp.domain.Job;
import com.pdio.jhipsterapp.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.pdio.jhipsterapp.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
